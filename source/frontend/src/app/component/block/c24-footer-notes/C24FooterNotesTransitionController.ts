...
import C24FooterNotes from './C24FooterNotes';
import { verticalFadeIn } from '../../../util/transition-helpers';

class C24FooterNotesTransitionController extends MubanTransitionController {
  protected setupTransitionInTimeline(
    timeline: TimelineMax,
    parent: C24FooterNotes,
    id: string,
  ): void {
...
export default C24FooterNotesTransitionController;
