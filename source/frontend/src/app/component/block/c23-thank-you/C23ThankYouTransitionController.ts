...
import C23ThankYou from './C23ThankYou';
import { verticalFadeIn } from '../../../util/transition-helpers';

class C23ThankYouTransitionController extends MubanTransitionController {
...
export default C23ThankYouTransitionController;
