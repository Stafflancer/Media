...
import C12OurLocations from './C12OurLocations';
import { verticalFadeIn } from '../../../util/transition-helpers';

class C12OurLocationsTransitionController extends MubanTransitionController {
  protected setupTransitionInTimeline(
    timeline: TimelineMax,
    parent: C12OurLocations,
    id: string,
  ): void {
...
export default C12OurLocationsTransitionController;
