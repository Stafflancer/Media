...
import C16JobOpenings from './C16JobOpenings';
import { verticalFadeIn } from '../../../util/transition-helpers';

class C16JobOpeningsTransitionController extends MubanTransitionController {
  protected setupTransitionInTimeline(
    timeline: TimelineMax,
    parent: C16JobOpenings,
    id: string,
  ): void {
...
export default C16JobOpeningsTransitionController;
